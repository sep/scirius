    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostname', models.CharField(max_length=100, unique=True, error_messages={b'unique': b'The entered hostname already exists.'}, validators=[probes.models.validate_hostname])),
